        ...
        while self.isrunning:
            while interface.isactif:
                ...
                if len(interface.recorder.buffer) > interface.start_currSegment+longueur_segment+1:
                    ...
                    interface.ws = MyClient(frames, interface.uri + '?%s' % (urllib.urlencode([("content-type", interface.content_type)])), byterate=interface.rate,
